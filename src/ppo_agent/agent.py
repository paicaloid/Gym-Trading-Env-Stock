...
from ppo_agent.networks import ActorNetwork, CriticNetwork
...
class PPOExperience:
    ...
    def generate_batches(self):
        """
        generates batches of experiences from the stored lists for
        ...
        It then shuffles the indices randomly and splits them into
...
class Agent:
    ...
    def learn(self):
        ...
        - calculates advantages for each experience using Generalized Advantage
            Estimation (GAE).
        - calculates the actor and critic losses for each batch and  performs
            a backpropagation step
